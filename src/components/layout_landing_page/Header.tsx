...
export default function HeaderLandingPage() {
  ...
  const navItems = ["Trang chủ", "Giới thiệu", "Đại lý", "Mua Proxy", "Liên hệ"];
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="absolute left-0 right-0 mt-4 rounded-2xl border border-white/10 bg-black/50 p-6 backdrop-blur-xl lg:hidden"
          >
