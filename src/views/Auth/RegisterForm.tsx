...
export default function RegisterForm() {
  ...
  return (
    <form className="login-modal-form" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="login-form-group">
        <label className={`login-form-label ${errors.password_confirmation && 'text-red-500'}`}>Nhập lại mật khẩu</label>
        <div className="login-password-wrapper">
          <input
            type={showPassword ? 'text' : 'password'}
          ...
          >
            {showPasswordConfirm ? <EyeOff size={20} color="#999" /> : <Eye size={20} color="#999" />}
          </button>
        </div>
        {errors.password && (
