...
export default function DetailUserModal({
  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-lg shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden animate-slideUp mx-auto">
        ...
        {isLoading ? (
           ...
           <p className="text-gray-600 font-medium text-sm sm:text-base text-center">Đang tải thông tin người dùng...</p>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-3 sm:p-4 border border-orange-200">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-orange-900">{user?.totalOrders ?? 0}</div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 sm:p-4 border border-green-200">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-green-900">{user?.totalSpent ?? 0}</div>
              <div className="text-xs text-green-600 mt-1">Giá trị mua hàng</div>
            </div>
          </div>

          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between p-3 sm:p-4 bg-white border border-gray-200 rounded-lg hover:border-orange-300 hover:shadow-sm transition-all group">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-orange-100 flex items-center justify-center group-hover:bg-orange-200 transition-colors flex-shrink-0">
                  <Mail size={16} className="text-orange-600 sm:w-[18px] sm:h-[18px]" />
                </div>
              ...
              <ChevronRight size={16} className="text-gray-400 group-hover:text-orange-500 transition-colors flex-shrink-0 sm:w-[18px] sm:h-[18px]" />
            </div>

            <div className="flex items-center justify-between p-3 sm:p-4 bg-white border border-gray-200 rounded-lg hover:border-orange-300 hover:shadow-sm transition-all group">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-orange-100 flex items-center justify-center group-hover:bg-orange-200 transition-colors flex-shrink-0">
                  <Phone size={16} className="text-orange-600 sm:w-[18px] sm:h-[18px]" />
                </div>
                <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center justify-between p-3 sm:p-4 bg-white border border-gray-200 rounded-lg hover:border-orange-300 hover:shadow-sm transition-all group">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-orange-100 flex items-center justify-center group-hover:bg-orange-200 transition-colors flex-shrink-0">
                  <Calendar size={16} className="text-orange-600 sm:w-[18px] sm:h-[18px]" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="text-xs text-gray-500 mb-0.5">Ngày tham gia</div>
                  <div className="text-xs sm:text-sm font-medium text-gray-900 truncate">{user?.joinDate ? formatDateTimeLocal(user.joinDate) : '—'}</div>
                </div>
              </div>
              <ChevronRight size={16} className="text-gray-400 group-hover:text-orange-500 transition-colors flex-shrink-0 sm:w-[18px] sm:h-[18px]" />
            </div>
            ...
            <div className="flex items-center justify-between p-3 sm:p-4 bg-white border border-gray-200 rounded-lg hover:border-orange-300 hover:shadow-sm transition-all group">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-xs text-gray-500 mb-0.5">Đăng nhập lần cuối</div>
                  <div className="text-xs sm:text-sm font-medium text-gray-900 truncate">{user?.lastLogin ? formatDateTimeLocal(user.lastLogin) : '—'}</div>
                </div>
              </div>
              <ChevronRight size={16} className="text-gray-400 group-hover:text-orange-500 transition-colors flex-shrink-0 sm:w-[18px] sm:h-[18px]" />
            </div>
