        ...
        {isLoading ? (
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 sm:p-4 border border-green-200">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-green-900">{new Intl.NumberFormat('vi-VN').format(data?.user?.chitieu) + ' đ'}</div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 sm:p-4 border border-green-200">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-green-900">{new Intl.NumberFormat('vi-VN').format(data?.user?.sotiennap) + ' đ'}</div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 sm:p-4 border border-green-200">
              ...
              <div className="text-2xl sm:text-3xl font-bold text-green-900">{new Intl.NumberFormat('vi-VN').format(data?.user?.sodu) + ' đ'}</div>
