          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 mb-4">
              <div className="footer-section">
                <h4>Products</h4>
                <ul className="footer-links">
                  <li><a href="#">Proxy Dân cư Tỉnh</a></li>
                  <li><a href="#">Proxy Dân cư Xoay</a></li>
                </ul>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6 mb-4">
              <div className="footer-section">
                <h4>Get started</h4>
                <ul className="footer-links">
                  <li><a href="#">Trở thành CTV</a></li>
                  <li><a href="#">Trở thành đại lý uy quyền</a></li>
                  <li><a href="#">Mua proxy giá rẻ</a></li>
                  <li><a href="#">Tương tác tự vận</a></li>
            ...
            <div className="col-md-6">
              <div className="footer-legal">
                ...
                <div className="copyright">
                  © 2025 HOME PROXY COMPANY LIMITED. All Rights Reserved
                </div>
              </div>
            </div>
          </div>
