        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            ...
            <div className="proxy-info-section">
              <h3 className="proxy-title">
                Proxy Dân Cư tỉnh Việt Nam
              </h3>
              <p className="proxy-description">
                Hệ thống máy chủ đặt tại nhiều khu vực trong điểm trên cả ba miền, đang
                từng bước mở rộng phủ sóng đủ 34 tỉnh thành. Hạ tầng xây dựng với tiêu
                chuẩn ổn định cao, trang bị đầy đủ thiết bị dự phòng để luôn sẵn sàng,
                tránh tối đa mọi sự cố
              </p>
              ...
              <div className="features-list">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="feature-item-vietnam"
                    style={{ '--animation-delay': `${index * 0.1}s` }}
                  >
                    <div className="feature-icon-vietnam">
                      {feature.icon}
                    </div>
