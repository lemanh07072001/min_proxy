            ...
            <div className='hero-content'>
              ...
              <div className='hero-features'>
                <div className='feature-item'>
                  ...
                  <span className="text-gray-50">Phủ sóng 64 tỉnh thành</span>
                </div>
                <div className='feature-item'>
                  <div className='feature-icon'>
                    <Zap size={20} />
                  </div>
                  <span className="text-gray-50">Tốc độ lên đến 1Gbps</span>
                </div>
                <div className='feature-item'>
                  <div className='feature-icon'>
                    <Shield size={20} />
                  </div>
                  <span className="text-gray-50">Uptime 99.9%</span>
                </div>
                <div className='feature-item'>
                  <div className='feature-icon'>
                    <Users size={20} />
                  </div>
                  <span className="text-gray-50">Hỗ trợ 24/7</span>
                </div>
              </div>
