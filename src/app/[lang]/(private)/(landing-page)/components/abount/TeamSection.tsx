      ...
      <div className='container-lg'>
        <div className='section-header text-center'>
          ...
          <p className='section-subtitle-modern'>
            Đội ngũ {process.env.NEXT_PUBLIC_APP_NAME} gồm những chuyên gia công nghệ giàu kinh nghiệm, tận tâm và nhiệt
            huyết. Chúng tôi cam kết mang đến dịch vụ proxy chất lượng cao và hỗ trợ khách hàng tận tình 24/7.
          </p>
        </div>
            ...
            <div className='team-content'>
              <div className='team-description'>
                ...
                <p>
                  ...
                  lĩnh vực mạng và bảo mật. Với kinh nghiệm trung bình 5+ năm, chúng tôi hiểu rõ nhu cầu và thách thức
                  của khách hàng, từ đó đưa ra những giải pháp tối ưu nhất.
                </p>

                <p>
                  Chúng tôi không chỉ cung cấp dịch vụ mà còn đồng hành cùng khách hàng trong suốt quá trình sử dụng.
                  Đội ngũ kỹ thuật luôn sẵn sàng hỗ trợ, tư vấn và giải quyết mọi vấn đề một cách nhanh chóng và hiệu
                  quả.
                </p>
              ...
              <div className='team-image-modern'>
                ...
                <div className='team-grid'>
                  ...
                  <div className='team-member member-2'>
                    <img
                      src='https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=80&h=80&fit=crop&crop=face'
                      alt='Team Member'
                    />
                  </div>
                  <div className='team-member member-3'>
                    <img
                      src='https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg?auto=compress&cs=tinysrgb&w=80&h=80&fit=crop&crop=face'
                      alt='Team Member'
                    />
                  </div>
                  <div className='team-member member-4'>
                    <img
                      src='https://images.pexels.com/photos/1043471/pexels-photo-1043471.jpeg?auto=compress&cs=tinysrgb&w=80&h=80&fit=crop&crop=face'
                      alt='Team Member'
                    />
                  </div>
